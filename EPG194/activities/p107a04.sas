...
*note that the lowercase basin values from storm_summary are 
not included in the report. we fix this with the code below:;
...
*note that the lowercase rows are included in the results.;
