...
title2 "Summary Statistics for MaxWindMPH and MinPressure";
...
*note that the title "Storm Analysis" appears above both reports for both steps;
*also, title2 appears above their respective reports for both steps.;
