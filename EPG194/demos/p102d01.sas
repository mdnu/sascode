...
*The code below will create a library named 'out';
libname out "/home/marknunez0/EPG194/output";

*The code below will make two copies of the "class" table from the
sashelp autolibrary and place them in two temp libraries: one in the
work library (default library), and the other in the 'out' library
which we defined in the statement above.;
