...
options validvarname=v7;
libname xlclass xlsx "/home/marknunez0/EPG194/data/class.xlsx";
...
libname xlstorm xlsx "/home/marknunez0/EPG194/data/storm.xlsx";

/* The above two statements will remove spaces in the storm.xlsx worksheet */
/* and replace them with underlines. */
